...
<form action="../Adds3"  method="post" enctype="multipart/form-data">
  <table class="list-style">
   <tr>
    <td style="text-align:right;width:15%;">产品名称：</td>
    <td><input type="text" class="textBox length-long xx" name="cname" value="${wlist[0].allProduct_name}"/></td>
   </tr>
   <tr>
    <td style="text-align:right;">产品分类：</td>
    <td>
     <select class="textBox sel"  name="cxxFn" value="${wlist[0].allProduct_picturename}">
   ...
   <tr>
    ...
    <td>
     <input type="text" class="textBox length-short" name="cprice" value="${wlist[0].allProduct_price}"/>
     <span>元</span>
    </td>
   </tr>
   ...
   <tr>
    ...
    <td>
     <input type="text" class="textBox length-short" name="ccount" value="${wlist[0].allProduct_count}"/>
     <span>盘</span>
    </td>
   </tr>
