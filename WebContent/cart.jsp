	...
	<body>
		...
		<div class="cart mt">
			...
			<div id="app">
				...
				<div class="table wrapper">
					...
					<div class="th" v-for="(item,index) in list">
						<div class="pro clearfix">
							...
							<a class="fl" href="#">
								<dl class="clearfix" >
									<dd class="fl"> <img :src="list[index].shoppingCart_location" style="width: 120px;height: 120px;"></dd>
									<dd class="fl">
						...
						<div class="price">￥{{item.shoppingCart_price}}</div>
						<div class="number">
							<p class="num clearfix">
								<img class="fl sub" src="img/temp/sub.jpg">
								<span class="fl">{{item.shoppingCart_count}}</span>
								<img class="fl add" src="img/temp/add.jpg">
							</p>
						</div>
						<div class="price sAll">￥{{ccc(item.shoppingCart_price*item.shoppingCart_count)}}</div>
						<div class="price"><a class="del" @click="delShopping(item.shoppingCart_id);">删除</a></div>
					</div>
					...
					<div class="tr clearfix">
						...
						<p class="fl">
							<a href="#">全选</a>
							<a class="del" @click="delShopping(null);">删除</a>
						</p>
						<p class="fr">
		...
		<script type="text/javascript">
			var vm = new Vue({
				...
				methods: {
					z_cart: function() {
						axios.get('zcart').then((ret) => {
							this.list = ret.data;
						});
					},
					delShopping:function(id){
						axios.get('delShopping',{
							params:{
								sid:id
							}
						}).then((ret) => {
